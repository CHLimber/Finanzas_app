"""
Archivo: gui/windows/b2_solvencia.py
Pestaña B2 - Ratios de Solvencia
"""
...
class B2SolvenciaTab(ttk.Frame):
    """Pestaña B2 - Ratios de Solvencia"""
    ...
    def crear_interfaz(self):
        ...
        ttk.Label(
            scrollable_frame,
            text="B.2 RATIOS DE SOLVENCIA",
            font=Fonts.TITLE,
            foreground=Colors.PRIMARY
        ).pack(pady=Dimensions.PADDING_LARGE)
        
        # Descripción breve
        desc = "Miden la capacidad de la empresa para cumplir todas sus obligaciones a largo plazo."
        ttk.Label(
            scrollable_frame,
            text=desc,
            font=Fonts.NORMAL,
        ...
        # Ratios
        ratios_info = [
            ("Ratio de Garantía", "ratio_garantia"),
            ("Ratio de Autonomía", "ratio_autonomia"),
